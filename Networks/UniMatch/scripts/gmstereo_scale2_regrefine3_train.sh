...
CHECKPOINT_DIR=checkpoints_stereo/StereoHybrid && \
mkdir -p ${CHECKPOINT_DIR} && \
python3.9 -m torch.distributed.launch --nproc_per_node=${NUM_GPUS} --master_port=9989 main_stereo.py \
--launcher pytorch \
--checkpoint_dir ${CHECKPOINT_DIR} \
--resume checkpoints_stereo/StereoHybrid/step_005900.pth \
--stage hybrid \
--lr 4e-4 \
--no_resume_optimizer \
--batch_size 1 \
