...
path_RGB_left = p + 'INDOORS/color/left'
path_RGB_right = p + 'INDOORS/color/right'
path_IR_left = p + 'INDOORS/thermal/left'
path_IR_right = p + 'INDOORS/thermal/right'

IR = Camera(path=path_IR_left, device=torch.device('cuda'), id='IR', f=12, name='SmartIR640', sensor_name='SmartIR640')
IR2 = Camera(path=path_IR_right, device=torch.device('cuda'), id='IR2', f=12, name='subIR', sensor_name='SmartIR640')
...
d_calib = 4.8
center_x, center_y, center_z = 0, 1, d_calib  # 341 * 1e-03, 1, 0
...
R.save(path_result, 'Cats_in.yaml')
