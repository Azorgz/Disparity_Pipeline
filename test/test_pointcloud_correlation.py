...
R = CameraSetup(from_file="/home/godeta/PycharmProjects/Disparity_Pipeline/Setup_Camera/Setup_Camera.yaml")
parser = get_config('zoedepth', "infer")
config = configure_parser(parser,
                          None,
                          path_config='/home/godeta/PycharmProjects/Disparity_Pipeline/Networks/Depth_anything/config_Depth_anything.yml',
                          dict_vars=None)
...
for i in range(10):
    ...
    matrix_src = R.cameras['IR'].intrinsics[:, :3, :3]
